...
output[Descending of 3 7 8 1 2 5 4 5 9 ]

input[N=8,numbers= 6 5 3 1 8 7 2 4]	
output[Descending of 3 5 6 1 7 8 2 4]

input[N=11,numbers= 6 5 3 1 8 7 4 2 0 30 20]	
output[Descending of 3 5 6 1 7 8 0 2 4 20 30]
*/

#include <bits/stdc++.h>
using namespace std;
void bubbleSortv3(int arr[], int startIndex, int endIndex, bool isAsc)//arr,3,6
{
...
void sortSublistv3(int arr[],int N,int sublistSize){
     ...
     {
        bubbleSortv3(arr,startIndex , endIndex, false);    //arr,0,2  arr,3,5      arr,6,8     arr,9,10
